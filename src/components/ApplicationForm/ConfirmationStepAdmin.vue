<template>
  <div v-if="isLoading">
    ...
    <v-row align="center" justify="center" class="margin-top-10-data-confirmation-admin mt-5">
  ...
  <div v-else-if="isDone">
    ...
    <v-row align="center" justify="center" class="confirmation-text margin-top-10-data-confirmation-admin mt-5">
