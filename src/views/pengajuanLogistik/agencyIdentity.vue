      ...
      <ValidationObserver ref="observer">
        <div class="col-sm-12">
          <v-card-text class="headerSection">
            <span><h4><b>{{ $t('route.applicant_form_edit') }}</b></h4></span>
          </v-card-text>
        </div>
        <div class="container">
          <div class="row">
            <div class="col-sm-6">
              <ValidationProvider v-slot="{ errors }" rules="requiredInstanceType">
                <span><b>{{ $t('label.instance_type') + ' (' + data.agency_type + ')' }}</b> <i class="text-small-first-step">{{ $t('label.must_fill') }}</i></span>
                <v-autocomplete
              ...
              >
                <v-label class="title"><b>{{ $t('label.instance_name') + ' (' + data.master_faskes_id + ')' }}</b> <i class="text-small-first-step">{{ $t('label.must_fill') }}</i></v-label>
                <v-autocomplete
            ...
            <div class="col-sm-6">
              ...
              >
                <v-label class="title"><b>{{ $t('label.city_name') + ' (' + data.location_district_code + ')' }}</b> <i class="text-small-first-step">{{ $t('label.must_fill') }}</i></v-label>
                <v-autocomplete
              ...
              >
                <v-label class="title"><b>{{ $t('label.district_name') + ' (' + data.location_subdistrict_code + ')' }}</b> <i class="text-small-first-step">{{ $t('label.must_fill') }}</i></v-label>
                <v-autocomplete
              ...
              >
                <v-label class="title"><b>{{ $t('label.village_name') + ' (' + data.location_village_code + ')' }}</b> <i class="text-small-first-step">{{ $t('label.must_fill') }}</i></v-label>
                <v-autocomplete
