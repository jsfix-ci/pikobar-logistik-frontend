...
export default {
  ...
  label: {
    ...
    logistic_acceptance_report_title: 'Laporan Penerimaan Barang',
    logistic_acceptance_report_description: 'Fitur ini memudahkan Anda sebagai pemohon untuk melakukan pelaporan penerimaan barang logistik dari Pemdaprov Jawa Barat. Untuk info lebih lanjut, Anda dapat mengklik tombol dibawah ini.',
    ...
    applicant_label_no_urgency: 'Tandai permohonan ini sebagai permohonan penting.',
    applicant_label_urgency: 'Permohonan ini adalah ',
    important_applicant: 'Permohonan Penting',
    button_applicant_urgency_important: 'Tandai Permohonan Penting',
    important: 'Penting!',
