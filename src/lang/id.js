...
export default {
  ...
  label: {
    ...
    loading_done_one: 'Terima kasih telah mengajukan permohonan logistik via PIKOBAR. Data yang diterima selanjutnya akan diverifikasi dan diproses lebih lanjut oleh Divisi Logistik GTPP Covid-19 Jawa Barat. Anda dapat melacak proses pernohonan pengajuan logistik Anda via Fitur Lacak Pengajuan Logistik dalam website ini.',
    loading_done_two: 'Jika Anda memiliki pertanyaan lebih lanjut, silakan hubungi Hotline PIKOBAR pada nomor 08112093306 atau melalui e-mail kami di digital.service@jabarprov.go.id.',
    ...
    dashboard_title: 'Dashboard Permohonan',
    dashboard_title_text: 'Data yang ditampilkan pada Dashboard merupakan data yang didapatkan dari form permohonan logistik pada laman berikut',
