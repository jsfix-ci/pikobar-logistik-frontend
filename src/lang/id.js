...
export default {
  route: {
    ...
    task_force: 'Satuan Tugas',
    release_order: 'Perintah Pengeluaran Barang',
  ...
  label: {
    ...
    warning: 'Peringatan',
    track: 'Lacak',
    self_track: 'Lacak Mandiri',
    admin_greeting: 'Hai Admin',
    ...
    vaccine_needs_request: 'Ajukan Kebutuhan Vaksin',
    request_vaccine: 'Ajukan Vaksin',
    track_request: 'Lacak Permohonan',
    ...
    select_warrant_status: 'Pilih Surat Perintah',
    select_mail_status: 'Pilih Status Surat',
    select_verification_status: 'Pilih Status Verifikasi',
    select_follow_up_status: 'Pilih Status Tindak Lanjut',
    pic: 'PIC',
    vaccine: 'Vaksin',
    ...
    will_be_verified_dialog: 'Data yang Anda masukkan sudah disimpan dan akan segera di verifikasi oleh admin.',
    fail_dialog: 'GAGAL!',
    ...
    requested_date: 'Tanggal Permohonan',
    leader_approval: 'Persetujuan Pemimpin',
    ...
    signing_status: 'Status Penandatanganan',
